...
function vw_medical_care_admin_theme_style() {
   ...
   wp_enqueue_style('vw-medical-care-custom-admin-style', get_template_directory_uri() . '/inc/getstart/getstart.css');
   wp_enqueue_script('vw-medical-care-tabs', get_template_directory_uri() . '/inc/getstart/js/tab.js');
}
...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  <button class="tablinks" onclick="vw_medical_care_open_tab(event, 'theme_lite')"><?php esc_html_e( 'Getting Started', 'vw-medical-care' ); ?></button>		  
				...
				<div class="info-link">
		  		...
		  		<div class="link-customizer">
					...
					<div class="first-row">
						...
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-images-alt"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_medical_care_post_settings') ); ?>" target="_blank"><?php esc_html_e('Post settings','vw-medical-care'); ?></a>
							</div>
							 <div class="row-box2">
						...
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-welcome-write-blog"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_medical_care_left_right') ); ?>" target="_blank"><?php esc_html_e('General Settings','vw-medical-care'); ?></a>
							</div>
							 <div class="row-box2">
