...
if(!class_exists('simpleNewsletter')) {
	...
	class simpleNewsletter {
		...
		public static function activate() {
			...
			add_option("simplenewsletter_successmessage", "Thank you for registering", null, "no");
			add_option("simplenewsletter_confirmedmessage", "Thank you for verifying your email", null, "no");
			add_option("simplenewsletter_confirmationemail", "Thanks for registering, click the link below to confirm your email", null, "no");
